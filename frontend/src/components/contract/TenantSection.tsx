        ...
        {editMode ? (
          <>
            <div className="flex flex-row gap-[0.4rem]">
              ...
              <input className="border px-2" value={editData?.infor?.full_name || ''} onChange={e => setEditData({ ...editData, infor: { ...editData.infor, full_name: e.target.value } })} required />
            </div>
            <div className="flex flex-row gap-[0.4rem]">
              <span className="font-semibold">Số điện thoại:</span>
              <input className="border px-2" value={editData?.infor?.phone_number || ''} onChange={e => setEditData({ ...editData, infor: { ...editData.infor, phone_number: e.target.value } })} required />
            </div>
            ...
            <div className="flex flex-row gap-[0.4rem]">
              ...
              <input className="border px-2" value={editData?.infor?.address_detail || ''} onChange={e => setEditData({ ...editData, infor: { ...editData.infor, address_detail: e.target.value } })} required />
            </div>
            <div className="flex flex-row gap-[0.4rem]">
              <span className="font-semibold">Số CMND/CCCD:</span>
              <input className="border px-2" value={editData?.infor?.national_id || ''} onChange={e => setEditData({ ...editData, infor: { ...editData.infor, national_id: e.target.value } })} required />
            </div>
            <div className="flex flex-row gap-[0.4rem]">
              <span className="font-semibold">Ngày cấp:</span>
              <input className="border px-2" type="date" value={editData?.infor?.national_id_date || ''} onChange={e => setEditData({ ...editData, infor: { ...editData.infor, national_id_date: e.target.value } })} required />
            </div>
            <div className="flex flex-row gap-[0.4rem]">
              <span className="font-semibold">Nơi cấp:</span>
              <input className="border px-2" value={editData?.infor?.national_id_address || ''} onChange={e => setEditData({ ...editData, infor: { ...editData.infor, national_id_address: e.target.value } })} required />
            </div>
          ...
          <>
            ...
            <div className="flex flex-row gap-[0.4rem]">
              ...
              <span>{data?.infor?.address_detail}
                {data?.infor?.ward
