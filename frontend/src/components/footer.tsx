...
export default function Footer() {
  return (
    <footer className="bg-[#fff] text-[#333] pt-[1rem] mt-auto border-t-[1px] mb-[50px]">
      <div className="mx-auto px-[5rem] flex flex-col justify-between items-center gap-4">
        <div className="flex flex-row justify-between w-full">
          ...
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="shadow-md w-[2rem] h-[2rem] flex items-center justify-center rounded-md"><img src={process.env.PUBLIC_URL + "/up-arrow.png"} alt="" className="h-[1.5rem]"/></button>
        </div>
